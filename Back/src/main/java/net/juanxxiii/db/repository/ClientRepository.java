...
public interface ClientRepository extends JpaRepository<Client, Integer> {
    ...
    @Query(value = "SELECT new net.juanxxiii.dto.ClienteCompletoDto(c.id, c.fullName, d.id, d.direction, t.id, t.number) FROM Client c INNER JOIN Direction d ON c.id = d.client INNER JOIN Telephone t ON c.id = t.client")
